...
class QAAgent:
    """
    Post-story Q&A agent that generates contextual example questions 
    ...
    def _fallback_questions(self, story: Dict) -> List[str]:
        ...
        # Simple, universal questions that work for any story
        return [
    ...
    def _fallback_answer(self, question: str, story_context: Dict) -> str:
        """Provide a basic fallback answer when LLM fails."""
